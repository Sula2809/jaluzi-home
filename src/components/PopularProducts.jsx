            ...
            <div className="bg-white max-w-[1475px] rounded p-12 space-y-12">
                ...
                <div className="flex justify-between gap-16">
                    ...
                    <div className="flex flex-col gap-7 w-3/5">
                        ...
                        <a className="bg-primary-foreground max-w-[268px] mt-auto py-3 px-16 text-secondary text-h4 rounded hover:bg-primary duration-300" href='https://wa.me/996775982180?text=Здравствуйте%2C+у+меня+есть+вопрос' target="_blank"
